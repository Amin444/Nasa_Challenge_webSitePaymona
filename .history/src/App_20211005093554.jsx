       ...
       <div className='titleBlock'>
        ...
        <div className='around2'>
          <div className='rightBlock'>
            <span 
            onClick={() => setPages(1)}
            className={classNames('lowText', pages === 1 ? 'activeText' : n)}>1.GET DATA</span>
            <span 
            onClick={() => setPages(2)}
            className='lowText'>2.BUILD EARTH MODEL</span>
            <span 
            onClick={() => setPages(3)}
            className='lowText'>3.CONNECT DEBRIS DATA</span>
            <span 
            onClick={() => setPages(4)}
            className='lowText'>4.ADD UI</span>
          </div>
        </div>
     </div>
